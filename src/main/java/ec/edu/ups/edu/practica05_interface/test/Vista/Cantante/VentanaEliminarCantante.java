...
private ResourceBundle mensajes;
     ...
     */
    public VentanaEliminarCantante(CantanteControlador cantanteControlador) {
        initComponents();
       ...
       jPanel2.setBorder(BorderFactory.createTitledBorder(mensajes.getString("PanelECantante")));
    }
    /**
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Eliminar Cantante"));

        jLabel9.setText("Ingrese el codigo del cantante que desea Eliminar");
    ...
    private void BtnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBuscarActionPerformed
        ...
        if (singer != null) {
            ...
            txtEdad1.setText(String.valueOf( singer.getEdad()));
            txtSalario1.setText(String.valueOf(singer.getSalario()));
        } else {
    ...
    private void BtnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEliminarActionPerformed
        ...
        int codigo = Integer.parseInt(txtCodigo1.getText());
        Cantante singer = cantanteControlador.Eliminar(codigo);
        if (singer != null) {
         txtNombre1.setText("");
